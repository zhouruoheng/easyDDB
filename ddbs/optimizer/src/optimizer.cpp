...
namespace db::opt
{
	...
	vector<metadataTable> getMetadata()
	{
		...
		frag1 = Fragment(make_pair("Customer", 1), 1, "vf", 15000);
		frag1.vf_column.push_back("Customer.id");
		frag1.vf_column.push_back("Customer.name");
		frag2 = Fragment(make_pair("Customer", 2), 2, "vf", 15000);
		...
		frag3 = Fragment(make_pair("Book", 3), 3, "hf", 40001);
		...
		frag1 = Fragment(make_pair("Orders", 1), 1, "hf", 13896);
		...
		frag2 = Fragment(make_pair("Orders", 2), 2, "hf", 32606);
		...
		frag3 = Fragment(make_pair("Orders", 3), 3, "hf", 15929);
		...
		frag4 = Fragment(make_pair("Orders", 4), 4, "hf", 37569);
